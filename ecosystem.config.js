module.exports = {
    ...
    deploy: {
        production: {
            ...
            'post-deploy': 'pwd && nvm use 16 && rm -rf node_modules/ && npm install && npm install && npm run build && pm2 startOrRestart /home/fsv-learnmat/ecosystem.config.js --env production && pm2 save',
        },
    },
}